        ...
        <div className="flex flex-col md:flex-row justify-around items-center gap-16 md:gap-6 w-full">
          <div className="flex flex-col gap-5 mb-0 md:mb-20">
            <div className="flex flex-col gap-2">
              <h1 className="text-5xl md:text-7xl font-bold text-neutral-800">Feel,<br />Write & Find&#128214;</h1>
              <p className="text-lg font-medium">A Place To Write And Read Our Feelings.</p>
            </div>
            <Link href={"/register"}>
              <button className="bg-blue-950 text-white px-7 ease-in-out duration-300 py-3 rounded-full font-medium flex gap-3 hover:gap-10 hover:bg-blue-900">Get Started <span>&#128640;</span></button>
            </Link>
          </div>
          <Image
